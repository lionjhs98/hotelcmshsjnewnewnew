        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="assignHouseKeepers"
                        to="/assigningstatuses/assignHouseKeepers"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="cleaningStatuses"
                        to="/cleaningstatuses/cleaningStatuses"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                title: 'AssignHouseKeeper', 
                description: '', 
                key: 'assignHouseKeepers', 
                route: '/assigningstatuses/assignHouseKeepers',
                ImageUrl: '',
            },
            { 
                title: 'Room', 
            ...
            { 
                title: 'CleaningStatus', 
                description: '', 
                key: 'cleaningStatuses', 
                route: '/cleaningstatuses/cleaningStatuses',
                ImageUrl: '',
            },
